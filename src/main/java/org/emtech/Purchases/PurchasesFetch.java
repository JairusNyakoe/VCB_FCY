    ...
    public void fetchAndSavePurchases() {
        ...
        String selectQuery = """
          ...
          CASE\s
                  ...
                  WHEN gam.acct_crncy_code = 'KES' and  pst.CRNCY_PURCHSD <> 'KES'
          
                  or gam.acct_crncy_code <> 'KES' and  pst.CRNCY_PURCHSD = 'KES'
        ...
        try (Connection conn = databaseConnection.dbConnection();
            ...
            while (rs.next()) {
                ...
                String insertSql = String.format("""
                    ...
                    VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','P','N')
                    """,
                        transRefCode, customerName, currency, amount, timestamp,
            ...
            if (batchSize == 0) {
                ...
                log.info("Purchases saved into custom.forex successfully .");
            }

        } catch (Exception e) {
            log.error("Error saving purchases into custom.forex", e);
        }
    }
}
