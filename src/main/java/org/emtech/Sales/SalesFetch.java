                      ...
                      TO_CHAR(PSTD_DATE, 'DD-MM-YYYY HH24:MI:SS') TIMESTAMP,
                       ...
                       CASE
                         ...
                         CASE
                           ...
                           WHEN TRIM(CRNCY_SOLD) = 'USD' THEN 1
        
                           ELSE custom.GetConvRate( TRIM(CRNCY_SOLD), 'USD',  'CBK',dtd.TRAN_DATE )
                       ...
                       CASE
                           ...
                           ELSE ROUND(  AMT_SOLD * custom.GetConvRate(  TRIM(CRNCY_SOLD),  'USD', 'CBK', dtd.TRAN_DATE ), 2)
